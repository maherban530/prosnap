...
//   const VoiceMessage(
//       {Key? key, required this.voiceUrl, required this.voiceName})
//       : super(key: key);
...
//     advancedAudioPlayer.setSourceUrl(widget.voiceUrl);
//   }
...
//     advancedAudioPlayer.onPositionChanged.listen((p) {
//       setState(() {
//         _position = p;
//       });
//     });

//     advancedAudioPlayer.onPlayerComplete.listen((playerState) {
//       setState(() {
